...
function SkeletonSlide() {
  return (
    <div className="flex-[0_0_100%] min-w-0 pl-2 min-[660px]:flex-[0_0_50%] min-[999px]:flex-[0_0_33.333%] min-[1300px]:flex-[0_0_25%] motion-reduce:[scroll-snap-align:start]">
      <div className="bg-[linear-gradient(160deg,rgb(24,24,24)_0%,rgb(18,18,18)_100%)] border border-white/[0.06] rounded-md overflow-hidden md:rounded-lg">
        ...
        <div className="flex flex-col gap-[0.3rem] p-[0.5rem_0.4rem] min-h-[155px] ms:gap-[0.35rem] ms:px-3 ms:py-[0.6rem] ms:pb-3 ms:min-h-[168px] md:gap-[0.42rem] md:p-[0.7rem] md:pb-4 md:min-h-[182px] lg:gap-2 lg:px-[1.2rem] lg:pb-[1.2rem] lg:pt-[0.85rem] lg:min-h-[195px]">
...
export default function CarouselSkeleton() {
  return (
    <div className="relative w-full max-w-[1200px] mx-auto mb-6 px-4" aria-hidden="true">
      <div className="overflow-hidden py-2 pb-[10px] md:py-2.5 md:pb-[14px] lg:py-3 lg:pb-4">
