...
export default function Products({ products, view = "grid" }: ProductsProps) {
  ...
  return (
    <main className={`w-full flex justify-center ${isList ? "[&>ul]:flex [&>ul]:flex-col [&>ul]:gap-[0.6rem] [&>ul]:max-w-full [&>ul]:p-0 md:[&>ul]:gap-[0.8rem] lg:[&>ul]:gap-4 min-[700px]:[&>ul]:flex min-[700px]:[&>ul]:flex-col min-[700px]:[&>ul]:gap-[0.6rem] min-[700px]:[&>ul]:max-w-full min-[700px]:[&>ul]:p-0" : ""}`}>
